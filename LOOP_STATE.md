...
- **Ronda 2026-08-27 (dentro de `/loop`), activar avisos de publicaciones de una cuenta ("🔔"), comparado con Instagram/Twitter/X**: las dos dejan tocar una campana en el perfil de alguien que sigues para que avise cada vez que publique algo nuevo -- a diferencia del resto de interacciones (like/comentario/mensaje/mención), una publicación nueva de alguien que sigues nunca generaba ningún aviso real en SOCIAL, ni siquiera opcional.
  ...
  - **Verificado real, no simulado**: RLS 335/335. Android `:app:compileDebugKotlin` OK a la primera (`BUILD SUCCESSFUL`), daemon detenido. iOS: pendiente de verificar en CI real tras el push (próxima entrada de esta misma ronda).
