...
final class NewPostViewModel: ObservableObject {
    ...
    /// StorageUploader.swift para el hallazgo de Storage.
    func post(caption: String, isSocialOnly: Bool, imageData: Data?) async -> Bool {
        ...
        do {
            ...
            try await SupabaseManager.shared.client
                .from("posts")
                .insert(NewPost(author_id: userID, caption: caption, is_social_only: isSocialOnly, media_url: mediaURL))
                .execute()
